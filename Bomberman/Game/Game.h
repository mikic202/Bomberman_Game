...
private:
	...
	void bomb_explosion_(std::vector<std::shared_ptr<Wall> > items_on_b);
	...
	bool check_enemies_();
	void display_player_move_sideways_(std::shared_ptr< Player> player, int multiplier);
	void display_player_move_forward_(std::shared_ptr< Player> player);
	void display_player_move_backward_(std::shared_ptr< Player> player);
	void generate_enemies_();
